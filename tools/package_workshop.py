...
DESCRIPTION = [
    ...
    "",
    "FLYING HER",
    "The landed shuttle is a vehicle with four seats -- get in as you would a car, pick a seat, switch seats, drive. From the pilot's seat, take her up: she lifts off the ground and hovers, clearing fences, hedges, wrecks and single-storey roofs, and she flies by *driving*, so the throttle, the steering and a controller all work exactly as they do on the ground. Up or down and nothing in between. Set her down again when you are there, or beam off her -- she goes back up by herself and waits to be called down. At the helm, click the map to lay in a course across Kentucky; the map is fully revealed while the helm is open, so you can aim at somewhere you have never been.",
    "",
    "THE CABIN",
